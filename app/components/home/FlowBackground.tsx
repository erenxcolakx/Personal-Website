...
export const FlowBackground = memo(function FlowBackground({
  className = "",
}: FlowBackgroundProps) {
  ...
  return (
    ...
    >
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 w-full h-full opacity-40 [mask-image:radial-gradient(circle_at_center,white,transparent_75%)]"
      />
