...
const education = [
  {
    ...
    description:
      "Focused on software engineering, algorithms, data structures, and modern programming paradigms. Built strong foundation in computer science fundamentals with emphasis on practical application.",
    achievements: [
                    ...
                    <div className="flex-1 p-6 rounded-2xl bg-white/60 dark:bg-neutral-900/60 backdrop-blur-md border border-black/10 dark:border-white/10 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] hover:shadow-[0_8px_24px_-4px_rgba(0,0,0,0.25)] transition duration-500">
                      ...
                      <ul className="space-y-1.5 mb-5">
                        {exp.achievements.map((a, i) => (
                          <li
                            key={i}
                            className="flex gap-2 text-xs md:text-sm text-gray-600 dark:text-gray-300"
                          >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((t) => (
                          <span
                            key={t}
                            className="px-2.5 py-1 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-[10px] md:text-xs tracking-wide text-gray-700 dark:text-gray-300 uppercase"
                          >
                            {t}
                          </span>
                        ))}
            ...
            >
              ...
              {education.map((edu, i) => (
                ...
                >
                  ...
                  <h5 className="text-xs font-semibold tracking-wide text-gray-700 dark:text-gray-200 mb-2 uppercase">
                    Highlights
                  </h5>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    date: "Oct 2023",
                    credentialId:
                      "eyJ1c2VyLWlkIjoxNDg2MDgsImNvdXJzZS1pZCI6MTE0NDY1LCJjZXJ0LWlkIjoiMTE0Njk3In0=",
                    ...
                    {cert.skills && (
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {cert.skills.map((s) => (
                          <span
                            key={s}
                            className="px-2 py-0.5 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-[10px] md:text-[11px] text-gray-700 dark:text-gray-300"
                          >
                            {s}
                          </span>
                        ))}
