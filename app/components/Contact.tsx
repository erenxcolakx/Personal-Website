...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="w-full py-24 bg-white dark:bg-black text-black dark:text-white relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-sm md:text-base">
            Have a product idea, collaboration or technical challenge? Let’s build something
            meaningful.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-14">
            ...
            >
              ...
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 leading-relaxed max-w-lg">
                Open to freelance work, early-stage product shaping, performance refactors and
                AI-assisted feature development. Reach out through any channel below.
              </p>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      {item.href ? (
                        <a
                          href={item.href}
                          className="text-sm md:text-base text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                        >
                          {item.value}
                        </a>
                      ) : (
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h4 className="text-sm font-semibold tracking-wider text-gray-700 dark:text-gray-300 uppercase mb-4">
                Social
              </h4>
              <div className="flex gap-4">
                <a
                  ...
                  aria-label="GitHub"
                  className="group relative w-12 h-12 rounded-xl bg-white/60 dark:bg-neutral-900/60 backdrop-blur flex items-center justify-center border border-black/10 dark:border-white/10 hover:shadow-[0_8px_24px_-4px_rgba(0,0,0,0.25)] transition"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="group relative w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 text-white flex items-center justify-center shadow hover:shadow-lg transition"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <Field label="Message" required>
                <textarea
                  ...
                  required
                  rows={6}
                  placeholder="Tell me about the idea or problem..."
...
const inputClass =
  "w-full px-4 py-3 rounded-xl bg-white/70 dark:bg-neutral-950/60 border border-black/10 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-sm text-gray-800 dark:text-gray-200 placeholder:text-gray-400 dark:placeholder:text-gray-500 transition";
