...
export function DualMarquee({
  ...
  return (
    <div
      className={`relative flex flex-col gap-6 select-none overflow-hidden ${className}`}
      aria-hidden
    >
      {/* Primary Line */}
      <div className="relative w-full overflow-hidden">
        ...
        {stroke && (
          ...
          >
            <span
              className={`font-extrabold tracking-tight leading-none ${primaryClassName} text-transparent [-webkit-text-stroke:1px_theme(colors.blue.500/30)] dark:[-webkit-text-stroke:1px_theme(colors.blue.300/35)] opacity-50`}
            >
              {primaryContent}
            </span>
          </motion.div>
