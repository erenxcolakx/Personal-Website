...
export const metadata = {
  ...
  description:
    "Personal portfolio showcasing full-stack development, software engineering, and innovative projects.",
  keywords:
    "developer, portfolio, react, nextjs, javascript, full-stack, eren colak, software engineer, web developer",
